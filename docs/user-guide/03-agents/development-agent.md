...
The Development Agent is driven by `DEVELOPMENT_AGENT_PROMPT` defined in [`config/agent_prompts.py`](../../../config/agent_prompts.py).
...
To customize Development Agent behavior, edit `DEVELOPMENT_AGENT_PROMPT` in `config/agent_prompts.py`.
